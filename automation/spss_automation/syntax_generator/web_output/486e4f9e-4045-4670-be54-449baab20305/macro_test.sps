...
*
* 플레이스홀더:
*   t1+a3+a6r+a7r+a8+a9+a10r+a11_1r+a11_2r        - TABLE 행 변수 (t1 포함)
*   a3 a6r a7r a8 a9 a10r a11_1r a11_2r   - 통계량 적용 변수 (공백 구분)
*   a3+a6r+a7r+a8+a9+a10r+a11_1r+a11_2r  - 행 변수 (t1 제외, + 구분)
*   전 체       - 전체 라벨
*   구 분       - 구분 라벨
*   업체수  - 업체수/응답수 라벨
* ═══════════════════════════════════════════════════════════════
