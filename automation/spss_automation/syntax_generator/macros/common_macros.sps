...
*
* [프로젝트별 수정 필요]
* 아래 매크로 내부의 배너(행) 변수를 프로젝트에 맞게 교체하세요.
*
* ── 현재 배너 설정 ──────────────────────────────────────────
*   TABLE 행 변수:  t1+a3+a6r+a7r+a8+a9+a10r+a11_1r+a11_2r
*   통계량 변수:    a3 a6r a7r a8 a9 a10r a11_1r a11_2r
*   전체 라벨:      전 체
*   구분 라벨:      구 분
*   업체수 라벨:    업체수
* ── 수정 방법 ──────────────────────────────────────────────
*   편집기에서 찾기/바꾸기 사용:
*   (1) t1+a3+a6r+a7r+a8+a9+a10r+a11_1r+ a11_2r → 새 배너(+ 구분)
*   (2) a3 a6r a7r a8 a9 a10r a11_1r  a11_2r    → 새 배너(공백 구분)
* ═══════════════════════════════════════════════════════════════
